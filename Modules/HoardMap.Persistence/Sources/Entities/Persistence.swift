...
public struct PersistenceController : Sendable {
    ...
    init(inMemory: Bool = false) {
        guard let modelURL = Bundle.module.url(forResource:"Model", withExtension: "momd") else { fatalError("No URL") }
        guard let model = NSManagedObjectModel(contentsOf: modelURL) else { fatalError("No model") }
